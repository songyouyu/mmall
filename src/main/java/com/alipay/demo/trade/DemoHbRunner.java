...
public class DemoHbRunner extends AbsHbRunner {
    ...
    public AlipayHeartbeatSynRequestBuilder getBuilder() {
        ...
        builder.setProduct(Product.FP);
        builder.setType(Type.CR);
        builder.setEquipmentId("cr1000001");
        builder.setEquipmentStatus(EquipStatus.NORMAL);
        builder.setTime(Utils.toDate(new Date()));
        builder.setStoreId("store10001");
        builder.setMac("0a:00:27:00:00:00");
        builder.setNetworkType("LAN");
        builder.setProviderId("2088911212323549");
        builder.setSysTradeInfoList(sysTradeInfoList);
        builder.setExceptionInfoList(exceptionInfoList);
        return builder;
    }
}
